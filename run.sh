...
python3.7 src/consumer_complaints.py ./insight_testsuite/tests/your-own-test_1/input/complaints.csv ./insight_testsuite/tests/your-own-test_1/output/report.csv